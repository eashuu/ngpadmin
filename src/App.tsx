...
function App() {
  ...
  async function handleSuccess(res) {
    try {
      ...
      const access_mail = ["23cb033@drngpit.ac.in","23ad034@drngpit.ac.in","23cb003@drngpit.ac.in","23mba101@drngpit.ac.in","23mba013@drngpit.ac.in","sdc@drngpit.ac.in","sdc@drngpasc.ac.in"]
  ...
  return (
    <div>
      <GoogleOAuthProvider clientId="818907771783-cnuqqmsjtfkuhk4dpujrgej5a5cgc7ji.apps.googleusercontent.com">
        {!isLoggedIn ? (
